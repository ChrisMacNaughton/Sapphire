    ...
    def parse_atomic_with_method
      ...
      while true
        ...
        when :'.'
          ...
          block = parse_block
          if block
            atomic = Call.new atomic, name, args, block, method_column_number
          else
            atomic = args ? (Call.new atomic, name, args, nil, method_column_number) : (Call.new atomic, name, [], nil, method_column_number)
          end
        when :[]
          next_token_skip_space
          atomic = Call.new atomic, :[], [], nil, method_column_number
        when :'['
